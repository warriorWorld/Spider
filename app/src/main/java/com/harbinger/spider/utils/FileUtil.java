package com.harbinger.spider.utils;
...
public class FileUtil {
    ...
    public static File getTOEFLReadDirectory() {
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator +
                "TOEFL" + File.separator + "read" + File.separator;
    ...
    public static File getTOEFLListenDirectory() {
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator +
                "TOEFL" + File.separator + "listen" + File.separator;
        File directory = new File(path);
        if (!directory.exists()) {
            directory.mkdirs();
        }
